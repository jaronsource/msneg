...
<div class="sales_index">
	<ul>
		...
		<li><a href="${pageContext.request.contextPath }/busiSalesClear/create"><img src="${pageContext.request.contextPath }/images/ico/ico_sale04.gif" width="159" height="168" alt="结算单" /></a></li>
		</ul>
		<ul>
