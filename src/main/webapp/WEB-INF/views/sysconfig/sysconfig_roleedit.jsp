...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="1" class="tbl_w">
		...
		<tbody>
			<tr>
				<th>名称</th>
				<td><form:input path="roleName" cssClass="input_text"/></td>
			</tr>
			<tr>
				<th>描述</th>
				<td><form:input path="roleRemarks" cssClass="input_text"/></td>
			</tr>
			<tr>
				<td colspan="2"><input type="submit" value="保存" /> <input type="button" value="返回" onclick="window.location='${pageContext.request.contextPath}/sysConfig/role';" /> </td>
			</tr>
		</tbody>
	</table>
	</form:form>
