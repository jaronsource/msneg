...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	...
	<div class="customer">
	<form:form modelAttribute="sysFunc">
	<table width="100%" cellspacing="0" cellpadding="0" border="1" class="tbl_w">
		...
		<tbody>
			<tr>
				<th>功能组</th>
				<td><form:input path="funcGroupcode" cssClass="input_text"/></td>
			</tr>
			<tr>
				<th>父功能</th>
				<td><form:input path="parent.funcId" cssClass="input_text"/></td>
			</tr>
			<tr>
				<th>名称</th>
				<td><form:input path="funcName" cssClass="input_text"/></td>
			</tr>
			<tr>
				<th>地址</th>
				<td><form:input path="funcUrl" cssClass="input_text"/></td>
			</tr>
			<tr>
				<th>描述</th>
				<td><form:input path="funcRemarks" cssClass="input_text"/></td>
			</tr>
			<tr>
				<th>序号</th>
				<td><form:input path="funcOrder" cssClass="input_text"/></td>
			</tr>
			<tr>
				<td colspan="2"><input type="submit" value="保存" /> <input type="button" value="返回" onclick="window.location='${pageContext.request.contextPath}/sysConfig/func';" /> </td>
			</tr>
		</tbody>
	</table>
	</form:form>
