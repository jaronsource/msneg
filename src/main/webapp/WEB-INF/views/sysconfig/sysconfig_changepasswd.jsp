...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
		...
		<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="-1" aria-controls="tabs-2" aria-labelledby="ui-id-2" aria-selected="false"><a href="${pageContext.request.contextPath}/sysConfig/changePassword" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-2">更改密码</a></li>
	...
	<div class="customer">
		...
		<table class="tbl_w" border="1" cellpadding="0" cellspacing="0" width="100%">
			<colgroup>
				<col width="140">
				<col width="*">
			</colgroup>
			<tbody>
				<tr>
					<th>旧密码</th>
					<td><input type="password" name="oldPassword" class="input_text"/> </td>
				</tr>
				<tr>
					<th>新密码</th>
					<td><input type="password" name="newPassword" class="input_text" /></td>
				</tr>
				<tr>
					<th>确认密码</th>
					<td><input type="password" name="confirmPassword" class="input_text" /></td>
				</tr>
				<tr>
					<td colspan="2"><input type="submit" value="保存" /> <input type="button" value="返回" onclick="window.location='${pageContext.request.contextPath}/sysConfig';" /> </td>
				</tr>
			</tbody>
		</table>
		</form>
