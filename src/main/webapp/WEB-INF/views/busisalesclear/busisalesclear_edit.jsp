...
function addSaleItems(element, value) {
	...
	var $td5 = $('<td><span class="money itemPrice">' + value.itemPrice + '</span></td>');
	var $td6 = $('<td><span class="money itemSum">' + value.itemSum + '</span></td>');
	var $td7 = $('<td><span class="itemRemarks" >' + value.itemRemarks + '</span></td>');
...
<div class="customer">
	...
	<script>
		function select(event, ui) {
			...
			$('#servLogis').text(ui.item.servLogis);
			$('#servGetmethod').text(ui.item.servGetmethod);
			$('#servInstallmethod').text(ui.item.servInstallmethod);
...
<!--box-->
	...
	<div class="com_box">
		...
		<table width="100%" border="1" class="tbl_w" cellspacing="0" cellpadding="0">
			...
			<tbody>
				<tr>
					<th>物流信息</th>
					<td><span id="servLogis"> </span></td>
					<th>取送方式</th>
					<td><span id="servGetmethod"> </span></td>
					<th>安装方式</th>
					<td><span id="servInstallmethod"> </span></td>
				</tr>
			</tbody>
		</table>
	...
	<div class="com_box">
		...
		<table width="100%" border="1" class="tbl_w" cellspacing="0" cellpadding="0">
			...
			<tbody>
				<tr>
					<th>总金额</th>
					<td>¥ <span id="feeSum" class="money">0.00</span></td>
					<th>预付金额</th>
	...
	<div class="com_box">
		...
		<table width="100%" border="1" class="tbl_w" cellspacing="0" cellpadding="0">
			...
			<tbody>
				<tr>
					<td><span id="otherRemarks"></span>&nbsp;</td>
				</tr>
			</tbody>
		</table>
