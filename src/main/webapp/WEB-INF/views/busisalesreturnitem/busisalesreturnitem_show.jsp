				...
				<table width="100%" border="1" class="tbl_w" cellspacing="0" cellpadding="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><span class="money">${entry.busiSalesItem.itemPrice }</span></td>
							<td><span class="money">${entry.returnPrice }</span></td>
							<td><span class="money">${entry.returnSum }</span></td>
							<td><dict:lookupDictValue key="${entry.returnReasonKey }" type="return_reason" /></td>
							<td>${entry.busiSalesItem.itemRemarks}</td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
